...
<script lang="ts">
    ...
    async function loadProduct() {
        try {
            product = await productEditService.loadProduct(id);
...
{#snippet images()}
    <Card.Root>
        <Card.Header>
            ...
            <Card.Description>
                Add high-quality images to showcase your product. The first
                image will be used as the thumbnail.
            </Card.Description>
        </Card.Header>
        <Card.Content class="space-y-4">
            <div
    ...
    <Card.Root>
        ...
        <Card.Content>
            <div class="text-center py-12 text-muted-foreground">
                ...
                <p class="text-sm">
                    Advanced variant management will be available in the next
                    update.
                </p>
            </div>
        </Card.Content>
...
{:then}
    <Column class="[&>*]:w-full items-center">
        ...
        <Group class="max-w-7xl md:flex-col md:[&>*]:w-full">
            <div class="flex-1">
        ...
        <AlertDialog.Content>
            <AlertDialog.Header>
                ...
                <AlertDialog.Description>
                    This action will archive the product "{product.title}".
